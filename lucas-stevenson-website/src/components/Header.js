...
function Header(props) {
    return (
        <header className="text-platinum border-solid border-b-2 border-black block text-center sm:flex sm:justify-between p-8 bg-onyx text-xl">
            <Link to="/home" className="hover:text-silverSand hover:underline">Lucas Stevenson</Link>
            <nav className="text-center border-t-2 sm:border-none">
                <Link to="/about" className="pr-2 hover:text-silverSand hover:underline">About Me</Link>
                <Link to="/projects" className="pr-2 hover:text-silverSand hover:underline">My Projects</Link>
